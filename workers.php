<?php
    ...
    if(isset($_COOKIE['users_id']) and isset($_COOKIE['users_hash']) and ($countrowisdeleted >= 1))
    {
        ...
        {
            echo "<p><a href = 'index.html'>Главная</a> > <a href = 'cabinet.php'>Личный кабинет</a> > <a href = 'tables.php'>Таблицы</a> > <a>Работники библиотеки</a></p>";
            $queryfortable = mysqli_query($link, "SELECT workers_id, workers_name, workers_position, workers_phone FROM Workers");
            $countrowfortable = mysqli_num_rows($queryfortable);
            echo "<h1>Таблица: Работники библиотеки</h1>";
            ...
            echo "</table><br>";
            echo "<a href = 'addworker.php'><input type = 'button' value = 'Добавить запись о работнике'></a><br><br>";
            echo "<a href = 'updateworker.php'><input type = 'button' value = 'Редактировать информацию о работнике'></a><br><br>";
            echo "<a href = 'deleteworker.php'><input type = 'button' value = 'Удалить запись о работнике'></a>";
        }
        else
        {
